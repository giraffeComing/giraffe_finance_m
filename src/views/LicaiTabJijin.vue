<template>
    <div class="route-fade-in"  ref="comBodyJijin">
        <div>
            <div class="jj-tags">
                <div class="tag-bg01">10元专区</div>
                <div class="tag-bg02">新手专享</div>
                <div class="tag-bg03">热门行业</div>
            </div>
            <!--货币基金，要独立拆分组件-->
            <div class="bg-fff">
                <div class="jj">
...
//                  $nextTick这个方法保证了dom结构加载完成之后再执行
        ...
        methods:{
            getTypeOne() {
                return this.axios.get(API_ROOT+'/api/productfund/index?type=1');
            },
            getTypeTwo() {
                return this.axios.get(API_ROOT+'/api/productfund/index?type=2');
            },
            getTypeA() {
                return this.axios.get(API_ROOT+'/api/productfund/index?type=A');
            },
            _JijinScroll() {
...
<style scoped lang="scss" rel="stylesheet/scss">
    ...
    .footerbg{
        height: 1.42rem;
        background: url("../assets/jjfooterbg.png") no-repeat;
        background-size: 100% 100%;
    }
    .h50{
        height: 2rem;
